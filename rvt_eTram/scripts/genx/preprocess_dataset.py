...
dataset_2_height = {"gen1": 240, "gen4": 720, "testdata": 720}
dataset_2_width = {"gen1": 304, "gen4": 1280, "testdata": 1280}
...
class H5Reader:
    def __init__(self, h5_file: Path, dataset: str = "gen4"):
        ...
        # TODO: update dataset name
        assert dataset in {"gen1", "gen4", "testdata"}
...
def prophesee_bbox_filter(labels: np.ndarray, dataset_type: str) -> np.ndarray:
    # TODO: update dataset name
    assert dataset_type in {"gen1", "gen4", "testdata"}
...
def crop_to_fov_filter(labels: np.ndarray, dataset_type: str) -> np.ndarray:
    # TODO: update dataset name
    assert dataset_type in {"gen1", "gen4", "testdata"}, f"{dataset_type=}"
...
def get_base_delta_ts_for_labels_us(
    ...
    # TODO: update dataset name
    assert dataset_type in ["gen4", "testdata"]
...
if __name__ == "__main__":
    ...
    # TODO: update dataset name
    assert dataset in ("gen1", "gen4", "testdata")
    downsample_by_2 = True if dataset in ["gen4", "testdata"] else False
