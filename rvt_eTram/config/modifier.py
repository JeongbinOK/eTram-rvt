...
def dynamically_modify_train_config(config: DictConfig):
    with open_dict(config):
        ...
        assert dataset_name in {'gen1', 'gen4', 'gen4_sample', 'gen4_extended_sample'}
        ...
        if mdl_name == 'rnndet':
            ...
            if not mdl_cfg.head.num_classes:
                num_classes = 2 if  dataset_name == 'gen1' else 3 # 8 # 3
                mdl_cfg.head.num_classes = num_classes
            else:
                num_classes = mdl_cfg.head.num_classes
